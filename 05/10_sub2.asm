...
section .text
    main: ;tell linker entry point
        ...
        mov eax, SYS_WRITE
        mov ebx, STDOUT
        mov ecx, msg3       ; msg3 db "The difference is: "
        mov edx, len3
        int 0x80
        ...
        ; difference is now in eax, as a number
        ; add '0' to to convert the sum from decimal to ASCII
        add eax, '0'

        ; now eax contains the difference in the form of a character.
        
        ; storing the difference in memory location res
        mov [res], eax
